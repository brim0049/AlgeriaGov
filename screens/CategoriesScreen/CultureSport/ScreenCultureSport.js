...
import ModalComponentCultureSport from './ModalComponent';
export const documentCategories = [
  {
    id: 1,
    title: 'Culture',
    items: ['Déclaration préalable à l’exercice des activités du livre',
     'Certificat de qualification d’architecte des monuments et des sites', 
     'Prix Ali maachi',
     "Carte d'artiste",
    'Carte professionnelle du cinéma',
  'Subvention annuelle des associations culturelles'],
  },
  {
    id: 2,
    title: "Sport",
...
export default function ScreenCultureSport() {
