...
import ModalComponentDroitJustice from './ModalComponent';
export const documentCategories = [
  {
    id: 1,
    title: 'Documents judiciaires',
    items: ["Rectification électronique des erreurs contenues dans les registres d'état civil",
     "Obtention d'une copie conforme du décret de naturalisation en ligne", 
     'Suivi du cours de votre affaire',
     "Obtention du certificat de nationalité en ligne",
    'Demande et retrait en ligne du casier judiciaire (Bulletin n°03)',
...
"Copies d'actes des tribunaux du droit musulman El-Mahakim El-Charîa"],
  ...
  {
    id: 2,
    title: "Services judiciaires",
    items: [
      'E-doléance-Mjustice',
      'E-participation-Mjustice',
      "Parquet électronique",
    ],
  },

];
export default function ScreenDroitJustice() {
